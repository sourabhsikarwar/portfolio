          ...
          <div
            ...
            >
              <h3 className={styles.heading5}>
                Full Stack Developer Intern - <span className="text-gradient">CausalFunnel</span>
              </h3>
            ...
            >
              <h3 className={styles.heading5}>
                Software Developer Intern - <span className="text-gradient">OneAssure</span>
            ...
            >
              <h3 className={styles.heading5}>
                Web Developer Intern - <span className="text-gradient">Endeavor Welfare Society</span>
              </h3>
              <time className="text-xs mt-2 font-semibold uppercase tracki text-gradient">
                June 2021 - July 2021
              </time>
