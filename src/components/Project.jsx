      ...
      return (
        <section className={layout.sectionReverse}>
          <div className={layout.sectionInfo}>
            ...
            <p className={styles.paragraph}>Built using <span className="font-semibold text-white dark:text-white">React.js and Firebase</span></p>
      ...
      return (
        <section className={layout.section}>
          ...
          <div className={layout.sectionInfo}>
            ...
            <p className={styles.paragraph}>Built using <span className="font-semibold text-white dark:text-white">React.js, Node.js, Express.js and MongoDB</span></p>
            <div className="flex gap-4 mt-4">
              <a
      ...
      return (
        <section className={layout.sectionReverse}>
          <div className={layout.sectionInfo}>
            ...
            <p className={styles.paragraph}>Built using <span className="font-semibold text-white dark:text-white">HTML, CSS, JS and BootStrap</span></p>
            <div className="flex gap-4 mt-4">
              <a
      ...
      return (
        <section className={layout.section}>
          ...
          <div className={layout.sectionInfo}>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5s`}>
              Website for K2Cloud, a startup that provides cloud security solutions to the businesses.
            </p>
            <p className={styles.paragraph}>Built using <span className="font-semibold text-white dark:text-white">HTML, CSS, JS and TailwindCSS</span></p>
            <div className="flex gap-4 mt-4">
              <a
